...
function renderIcon(h, locale, context) {
  ...
  var classString = (0, _classnames2['default'])((0, _extends5['default'])({}, (0, _propsUtil.getClass)(context), (_extends2 = {}, (0, _defineProperty3['default'])(_extends2, 'anticon', true), (0, _defineProperty3['default'])(_extends2, 'anticon-' + type, !!type), _extends2)));
  ...
  if (Component) {
    var innerSvgProps = {
      attrs: (0, _extends5['default'])({}, _utils.svgBaseProps, {
        viewBox: viewBox
      }),
  ...
  var iProps = (0, _extends5['default'])({}, restDataProps, {
    attrs: (0, _extends5['default'])({}, attrs, {
      'aria-label': type && locale.icon + ': ' + type,
      tabIndex: iconTabIndex
    }),
    on: (0, _extends5['default'])({}, listeners, data.nativeOn),
    'class': classString,
    staticClass: ''
  });
  return h(
...
var Icon = {
  ...
  render: function render(h, context) {
    ...
    var classString = (0, _classnames2['default'])((0, _extends5['default'])({}, (0, _propsUtil.getClass)(context), (_extends3 = {}, (0, _defineProperty3['default'])(_extends3, 'anticon', true), (0, _defineProperty3['default'])(_extends3, 'anticon-' + type, !!type), _extends3)));
    ...
    if (children) {
      ...
      innerNode = h(
        'svg',
        (0, _babelHelperVueJsxMergeProps2['default'])([_innerSvgProps2, {
          attrs: { viewBox: viewBox }
        }]),
        [children]
      );
    ...
    // functional component not support nativeOn，https://github.com/vuejs/vue/issues/7526
    var iProps = (0, _extends5['default'])({}, data, {
      on: (0, _extends5['default'])({}, listeners, data.nativeOn),
      'class': classString,
      staticClass: ''
    });
