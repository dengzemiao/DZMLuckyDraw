...
require('../assets/iconfont.less');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

exports['default'] = {
  methods: {
    getFinishIcon: function getFinishIcon() {
    ...
    getErrorIcon: function getErrorIcon() {
      var h = this.$createElement;
  ...
  render: function render() {
    ...
    return h(
      ...
      settings,
      [h(_index.Step, {
        attrs: { title: 'Finished', description: 'This is a description' }
      }), h(_index.Step, {
        attrs: { title: 'In Process', description: 'This is a description' }
      }), h(_index.Step, {
